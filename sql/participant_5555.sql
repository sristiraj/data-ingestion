select distinct unpiv.plan_num, unpiv.part_num, unpiv.part_subplan, unpiv.part_extension,unpiv.plan_year, unpiv.activity, 
...
select plan_num, part_num, part_subplan, part_extension,plan_year, stack(11,'401 EE contribution',cntrb_401k_ee,'415 Contribution',cntrb_415,'401K Catchup',cntrb_401k_ctchup,'Roth Contribution',
...
order by plan_num, part_num, part_subplan, part_extension, plan_year,activity
