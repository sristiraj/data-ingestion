...
cast(tbadcbdcppft.message_definedcontributionbenefits_definedcontributionplans_val_planaccountfundtable_val_planaccountfundbalanceunits as decimal(22,7)) fund_balance_units,
lfp.price,
...
cast(case when tbpavaa1.tbamessage_personattributes_val_additionalattributes_val_fieldname is not null then ltam_civ.`group` else null end as varchar(100)) uniformed_group
...
left outer join default.tba_json_balance_summary_root_message_definedcontributionbenefits_definedcontributionplans_val_planaccountfundtable tbadcbdcppft
...
left outer join default.tba_balance_summary_root_tbamessage_personattributes_val_additionalattributes tbpavaa
on tbpa.tbamessage_personattributes_val_additionalattributes = tbpavaa.id and 
tbpavaa.tbamessage_personattributes_val_additionalattributes_val_fieldname = 'C-PAYROLL-OFF-NUM'
left outer join default.tba_balance_summary_root_tbamessage_personattributes_val_additionalattributes tbpavaa1
on tbpa.tbamessage_personattributes_val_additionalattributes = tbpavaa1.id and 
tbpavaa1.tbamessage_personattributes_val_additionalattributes_val_fieldname = 'U-PAYROLL-OFF-NUM'
