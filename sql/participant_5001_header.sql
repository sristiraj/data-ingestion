...
hash(rt.tbamessage_header_platforminternalid,rt.tbamessage_header_globalPersonIdentifier,rt.tbamessage_header_nationaltaxid,rt.tbamessage_person_birthdate,tbwabcoc.tbamessage_benefitsworkerattributes_val_benefitscurrentorganizationcodes_val_value,tbpavaa.tbamessage_personattributes_val_additionalattributes_val_fieldvalue,tbwabcs.tbamessage_benefitsworkerattributes_val_benefitscurrentemploymentstatuses_val_value) as Hashkey,
