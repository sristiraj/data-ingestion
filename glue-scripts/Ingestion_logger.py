...
if __name__ == "__main__":
    ...
    #Write target data
    target = RawDataSink(write_params).write_target_data(source_with_audit)
    LoggerUtil.log_target_row_count(target, context, logger)
